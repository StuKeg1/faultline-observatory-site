...
import { FR_BT_0007 } from "./records/FR-BT-0007.js";
...
export const PROGRAMMES = [
  ...
  },
  {
    ...
    thresholdStatement:
      "Claims where the contested frontier lies in whether biological effects, measurements, interventions, or engineered systems are reliable and functionally meaningful in biological or clinical settings.",
    scopeStatement:
      "This programme tracks frontier claims whose central uncertainty concerns biological effects, relationships, measurements, interventions, or the construction and function of engineered biological systems. A claim belongs here when the contested frontier lies in whether a claimed biological effect, measurement, predictive relationship, or intervention is real and reliable, or whether an engineered biological system can perform and sustain its claimed function. Claims are not excluded because artificial intelligence, materials, or other technologies may be used to discover, measure, design, construct, or deliver them; nor are they included for that reason. The allocation criterion is the location of the primary contested frontier: biological validity, response, or function belongs here, while AI capability and material properties remain with the programmes that own those frontiers.",
  },
];
