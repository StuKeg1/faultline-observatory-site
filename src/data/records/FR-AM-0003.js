...
export const FR_AM_0003 = {
  ...
  instances: [
    {
      ...
      date: "1986",
      sources: [{ citation: "Bednorz, J. G. & Müller, K. A. Possible high Tc superconductivity in the Ba-La-Cu-O system. Z. Phys. B 64, 189–193 (1986).", url: "https://research.ibm.com/publications/possible-high-tlessinfgreaterclessinfgreater-superconductivity-in-the-ba-la-cu-o-system", doi: "10.1007/BF01303701" }],
    },
    {
      id: "IN-002",
      ...
      date: "1987 onward",
      sources: [{ citation: "Anderson, P. W. The Resonating Valence Bond State in La2CuO4 and Superconductivity. Science 235, 1196–1198 (1987).", url: "https://pubmed.ncbi.nlm.nih.gov/17818979/", doi: "10.1126/science.235.4793.1196" }],
    },
    {
      id: "IN-003",
      ...
      date: "1994 onward",
      sources: [{ citation: "Tsuei, C. C. et al. Pairing Symmetry and Flux Quantization in a Tricrystal Superconducting Ring of YBa2Cu3O7−δ. Phys. Rev. Lett. 73, 593–596 (1994).", url: "https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.73.593", doi: "10.1103/PhysRevLett.73.593" }],
    },
    {
      id: "IN-004",
      ...
      date: "2005–15",
      sources: [{ citation: "Keimer, B., Kivelson, S. A., Norman, M. R., Uchida, S. & Zaanen, J. From quantum matter to high-temperature superconductivity in copper oxides. Nature 518, 179–186 (2015).", url: "https://www.nature.com/articles/nature14165", doi: "10.1038/nature14165" }],
    },
    {
      id: "IN-005",
      ...
      date: "2015–24",
      sources: [
        { citation: "LeBlanc, J. P. F. et al. (Simons Collaboration on the Many-Electron Problem). Solutions of the Two-Dimensional Hubbard Model: Benchmarks and Results from a Wide Range of Numerical Algorithms. Phys. Rev. X 5, 041041 (2015).", url: "https://journals.aps.org/prx/abstract/10.1103/PhysRevX.5.041041", doi: "10.1103/PhysRevX.5.041041" },
        { citation: "Mazurenko, A. et al. A cold-atom Fermi-Hubbard antiferromagnet. Nature 545, 462–466 (2017).", url: "https://www.nature.com/articles/nature22362", doi: "10.1038/nature22362" },
      ],
    },
    {
      id: "IN-006",
      qualifiedEvent: "Critical low-energy spin fluctuations observed across the LSCO superconducting dome",
      description: "Radaelli et al. reported inelastic-neutron-scattering measurements of overdoped La2−xSrxCuO4 showing strongly temperature-dependent low-energy spin fluctuations with dynamical scaling. Combined with earlier underdoped measurements, the study identifies an extended region of critical spin fluctuations across the LSCO phase diagram and concludes that low-energy spin excitations and spatial disorder are central to strange-metal behaviour. This materially strengthens the empirical connection between magnetic fluctuations and the anomalous normal state from which superconductivity emerges, but the experiment does not demonstrate that those fluctuations are the microscopic superconducting pairing interaction. It is therefore supportive mechanistic evidence rather than mechanism identification.",
      vectors: ["supportive--critical-spin-fluctuations-across-lsco-dome"],
      date: "2026-03-28",
      sources: [{ citation: "Radaelli, J. et al. Critical spin fluctuations across the superconducting dome in La2−xSrxCuO4. Nature Communications 17, 4564 (2026).", url: "https://www.nature.com/articles/s41467-026-71319-w", doi: "10.1038/s41467-026-71319-w" }],
    },
    {
      id: "IN-007",
      qualifiedEvent: "Hubbard-model calculation localises net d-wave pair formation to the superexchange scale",
      description: "Sordi et al. used cellular dynamical mean-field theory to study the frequency structure of superconducting correlations in the two-dimensional Hubbard model across doping and interaction strength. They find pair-forming processes confined to frequencies set by the superexchange interaction, followed by pair-breaking processes, with no pair-forming or pair-breaking processes on the scale of the bare on-site interaction U. Within the studied Hubbard model, low-frequency superexchange-scale processes provide the net contribution to d-wave pairing. This is a more discriminating mechanistic result than generic model benchmarking, but it remains a model calculation and does not establish that the two-dimensional Hubbard model uniquely or completely describes pairing in real cuprate materials.",
      vectors: ["supportive--superexchange-scale-d-wave-pairing"],
      date: "2026-06-24",
      sources: [{ citation: "Sordi, G. et al. Dynamics of Superconducting Pairs in the Two-Dimensional Hubbard Model. Phys. Rev. Lett. 136, 256503 (2026).", url: "https://journals.aps.org/prl/abstract/10.1103/22h2-jxh4", doi: "10.1103/22h2-jxh4" }],
    }
  ],

  assessments: [
    // APPEND-ONLY. Do not modify existing entries.
    { id: "AS-001", date: "2024-01-15", pressureState: "fragmenting", verificationStage: "VS-03", summary: "The mechanism responsible for cuprate superconductivity has not been identified in the sense the claim requires. After nearly four decades of intensive research, the field possesses several well-developed theoretical frameworks — spin fluctuation models, RVB and related strongly-correlated electron theories, charge density wave coupling proposals — none of which has achieved sufficient community consensus, predictive completeness, or experimental confirmation to constitute identification. The 2015 Keimer et al. review formally acknowledged that no single theory accounts for all cuprate phenomenology, and that conclusion has not been overturned by subsequent work. The pressure state is FRAGMENTING: this is not fragmentation from diverging evidence across domains, but from genuine theoretical plurality — multiple frameworks that are each partially correct and none of which has been falsified or achieved consensus (BN-001). Quantum simulation of the Hubbard model (AT-001) is the clearest visible resolution path, though it has not yet been executed at a scale sufficient to settle the question.", assessorNote: null },
    { id: "AS-002", date: "2026-09-10", pressureState: "fragmenting", verificationStage: "VS-03", summary: "Editorial consistency assessment following LPR-001-D12. The mechanism responsible for cuprate superconductivity remains unidentified at the level required by the claim. Empirical constraints such as d-wave pairing symmetry are strong, while the pseudogap, competing and intertwined orders, anomalous normal-state behaviour, and strongly correlated modelling remain incompletely unified. RVB-based, spin-fluctuation, Hubbard-model and related approaches remain active without a decisive community-wide mechanism identification. Numerical benchmarking and cold-atom simulation have improved the ability to test candidate models but have not themselves reproduced the full cuprate problem or settled the microscopic pairing interaction. FRAGMENTING / VS-03 is therefore reaffirmed without a status transition.", assessorNote: "Append-only replacement rationale for source-fidelity corrections approved after LPR-001-D12; AS-001 retained as historical assessment and not silently rewritten." },
    { id: "AS-003", date: "2026-09-10", pressureState: "fragmenting", verificationStage: "VS-03", summary: "Record Review admitted two 2026 evidence instances that strengthen a magnetic/strong-correlation mechanism trajectory without resolving the claim. IN-006 experimentally establishes critical low-energy spin fluctuations across the LSCO superconducting dome and ties them to strange-metal behaviour, while IN-007 finds within the two-dimensional Hubbard model that the net d-wave pair-forming contribution occurs at frequencies set by the superexchange interaction. Together these results increase convergence between experimentally observed spin dynamics and a computationally specified magnetic pairing scale. The decisive bridge remains absent: neither result demonstrates that the observed spin fluctuations are the microscopic pairing interaction in real cuprates, nor establishes the Hubbard model as a unique complete description of those materials. FRAGMENTING / VS-03 is therefore reaffirmed without a status transition.", assessorNote: "Governed Record Review admission of IN-006 and IN-007. Evidence trajectory strengthened; no claim-resolution event." }
  ],
  ...
  openQuestions: [
    { id: "OQ-001", question: "Can sufficiently controlled Hubbard-model calculations or analogue/quantum simulations at experimentally relevant regimes reproduce the key cuprate constraints and provide a discriminating test among candidate microscopic mechanisms? If so, AT-001 becomes the primary evidence trajectory to watch.", raisedDate: "2024-01-15" },
    { id: "OQ-002", question: "Does the claim require that a single mechanism explains all cuprate superconductors, or only that the mechanism for the most studied cuprate family (YBCO, BSCCO, LSCO) has been identified? The Scope Note defers this question to evidence, but it may need to be answered before the claim can transition from FRAGMENTING to any resolved state.", raisedDate: "2024-01-15" },
    { id: "OQ-003", question: "The FRAGMENTING state in this record has a different character from FRAGMENTING in other corpus records. In FR-QE-0002 and FR-AI-0003, fragmentation arose from evidence diverging across domains or failure modes. Here it arises from theoretical plurality — multiple frameworks each partially correct. Is this the same pressure state or a distinct phenomenon within the FRAGMENTING label?", raisedDate: "2024-01-15" }
  ],
