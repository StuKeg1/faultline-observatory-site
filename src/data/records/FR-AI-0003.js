...
export const FR_AI_0003 = {
  ...
  openQuestions: [
    { id: "OQ-001", question: "Does increasing model capability make preference generalisation better or worse? INST-005 suggests worse; INST-006 suggests potentially better under specific training regimes. This question is not resolvable from current evidence and is the programme's central unresolved tension.", raisedDate: "2024-01-15" },
    ...
    { id: "OQ-003", question: "The three failure modes (adversarial, sycophantic, capability-outpacing) are independent. Does solving one have any effect on the others, or do they require independent solutions? Current evidence does not address this.", raisedDate: "2024-01-15" },
