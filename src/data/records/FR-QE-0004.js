...
export const FR_QE_0004 = {
  ...
  instances: [
    ...
    {
      id: "IN-007",
      qualifiedEvent: "qLDPC breakeven on trapped-ion hardware",
    ...
    {
      id: "IN-008",
      qualifiedEvent: "Real-time reinforcement-learning recalibration sustaining error-corrected operation",
